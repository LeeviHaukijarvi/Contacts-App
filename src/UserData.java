/**
 * Represents user data with attributes such as first name,
 * last name, ID, phone number, address, and email.
 *
 * Provides methods to set and retrieve each attribute
 * while checking validation rules.
 */
public class UserData {
     ...
     * If the number is not 10 or 11 digits long or if it contains non-digit characters.
     */
     ...
     * @throws IllegalArgumentException
     * If the address does not start with an uppercase letter or
     ...
     * @throws IllegalArgumentException If the email is less than 5 characters,
     *                                  or if it lacks '@' or '.' symbols.
     */
    ...
    /**
     * Checks if a given string can be used as a name,
     * ensuring it does not contain numbers or special characters.
     *
     ...
     */
    private static boolean canBeInName(final String name) {
